...
.PHONY: test-docker
test-docker: ## Run tests in Docker container using envtest (as required by assignment).
...
KIND_CLUSTER ?= kuberenetesoperator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kuberenetesoperator-builder
	$(CONTAINER_TOOL) buildx use kuberenetesoperator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kuberenetesoperator-builder
	rm Dockerfile.cross
